...
//-------------------------------------------------------------------------------------------------------
resultAccumulated monteCarloSimulation_enchanced2(int cards[], int l, int ph, int playerCount, int monteCarloMaxIteration, int r){
    resultGetHand _resultGetHand;
    for (int i = 0; i < 10 ; i++)
        _resultGetHand.getOdds[i] = 0;
...
*/
    ...
    resultAccumulated ra2 = monteCarloSimulation_enchanced2(cards2, 7,                                  //7 штук
                                                          2,                                  //фаза. 0-префлоп, 1 - флоп, 2 - тёрн, 3 -ривер
                                                          2,                                  //общее число игроков ( я + число оппонентов)
                                                          40000,
